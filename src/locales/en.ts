...
<ul>
  ...
  <li>The auto-keyword feature is dependent on the LLM and consumes a significant number of tokens.</li>
    ...
    chat: {
      ...
      uploadMax: 'Upload max 5 files each up to 5MB',
      attachFile: 'Attach file',
      sendMessage: 'Send message',
      fileRejected: '"{{fileName}}" has been rejected',
...
[Insert text here]`,
    ...
    search: {
      ...
      keywordBasedSearch: 'Keyword-Based Document Search (Provided by RAGFlow)',
      ads: 'ADS',
