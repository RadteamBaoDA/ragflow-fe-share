export default {
  translation: {
    common: {
      ...
      zoomOut: '縮小',
      zoomLevel: 'ズームレベル',
      hideHighlights: 'ハイライトを非表示',
      showHighlights: 'ハイライトを表示',
      automaticZoom: '自動ズーム',
      actualSize: '実際のサイズ',
      pageFit: 'ページに合わせる',
      pageWidth: 'ページ幅に合わせる',
...
上記が要約する内容です。`,
    ...
    search: {
      searchApps: '検索アプリ',
      createSearch: '検索を作成',
      searchGreeting: '今日は何をお手伝いしましょうか？',
      profile: 'プロフィールを非表示',
      locale: 'ロケール',
      embedCode: '埋め込みコード',
      id: 'ID',
      ...
      rerankModel: '再ランクモデル',
      AISummary: 'AI要約',
      enableWebSearch: 'ウェブ検索を有効化',
      enableRelatedSearch: '関連検索を有効化',
      showQueryMindmap: 'クエリマインドマップを表示',
      embedApp: 'アプリを埋め込む',
      relatedSearch: '関連検索',
      descriptionValue: 'あなたはインテリジェントなアシスタントです。',
      okText: '保存',
      cancelText: 'キャンセル',
      chooseDataset: '最初にデータセットを選択してください',
      ads: 'ADS',
      searchingPleaseWait: '検索中です、お待ちください...',
      advancedDocumentSearch: '高度なドキュメント検索',
      keywordBasedSearch: '👋 こんにちは、AIを活用したキーワードベース検索',
    },
    setting: {
      profile: 'プロファイル',
      avatar: 'アバター‌',
