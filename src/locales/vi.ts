  ...
  translation: {
    ...
    chat: {
      ...
      modelEnabledToolsTip:
        'Vui lòng chọn một hoặc nhiều công cụ để mô hình trò chuyện sử dụng. Nó không có tác dụng đối với các mô hình không hỗ trợ gọi công cụ.',
      freedom: 'Tự do',
      improvise: 'Tự do',
      precise: 'Chính xác',
      balance: 'Cân bằng',
      ...
      avatarHidden: 'Ẩn Avatar',
      locale: 'Ngôn ngữ',
      selectLanguage: 'Chọn ngôn ngữ',
      reasoning: 'Suy luận',
      reasoningTip: 'Bật quy trình suy luận cho các câu hỏi phức tạp (ví dụ: Deepseek-R1, OpenAI o1).',
      tavilyApiKeyTip:
        'Đặt khóa API Tavily tại đây để kích hoạt tính năng tìm kiếm trên web, bổ sung cho tìm kiếm cơ sở kiến thức.',
      tavilyApiKeyMessage: 'Vui lòng nhập khóa API Tavily',
      tavilyApiKeyHelp: 'Cách lấy khóa?',
      crossLanguage: 'Tìm kiếm đa ngôn ngữ',
      crossLanguageTip: 'Chọn một hoặc nhiều ngôn ngữ để tìm kiếm. Nếu không được chọn, tìm kiếm sẽ sử dụng ngôn ngữ truy vấn ban đầu.',
      createChat: 'Tạo Chat',
      metadata: 'Siêu dữ liệu',
      metadataTip: 'Sử dụng siêu dữ liệu để lọc thông tin (thẻ, quyền truy cập).',
      ...
      tocEnhance: 'Tăng cường TOC',
      tocEnhanceTip: 'Sử dụng mục lục để cải thiện kết quả tìm kiếm.',
      emptyConversation: 'Trống',
      you: 'Bạn',
      dragAndDrop: 'Kéo và thả tệp vào đây',
      uploadMax: 'Tải lên tối đa 5 tệp mỗi tệp tối đa 5MB',
      attachFile: 'Đính kèm tệp',
      sendMessage: 'Gửi tin nhắn',
      fileRejected: '"{{fileName}}" đã bị từ chối',
      documentPreviewer: 'Trình xem trước tài liệu',
      reset: 'Đặt lại',
    },
    setting: {
      profile: 'Hồ sơ',
    ...
    search: {
      ...
      searchGreeting: 'Tôi có thể giúp gì cho bạn hôm nay?',
      profile: 'Ẩn Hồ sơ',
      locale: 'Ngôn ngữ',
      embedCode: 'Mã nhúng',
      id: 'ID',
      ...
      showQueryMindmap: 'Hiển thị Sơ đồ Tư duy Truy vấn',
      embedApp: 'Nhúng Ứng dụng',
      relatedSearch: 'Tìm kiếm Liên quan',
      descriptionValue: 'Bạn là một trợ lý thông minh.',
      okText: 'Lưu',
      cancelText: 'Hủy',
      chooseDataset: 'Vui lòng chọn bộ dữ liệu trước',
      noDocumentFound: 'Không tìm thấy tài liệu',
      advancedDocumentSearch: 'Tìm kiếm Tài liệu Nâng cao',
      keywordBasedSearch: 'Tìm kiếm Tài liệu Dựa trên Từ khóa (Được cung cấp bởi RAGFlow)',
      ads: 'ADS',
      searchingPleaseWait: 'Đang tìm kiếm... Vui lòng đợi...',
